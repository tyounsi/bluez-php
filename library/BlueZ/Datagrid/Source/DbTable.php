...
/**
 * @see BlueZ_Datagrid_Source_DbSelect
 */
require_once 'BlueZ/Datagrid/Source/DbSelect.php';
 ...
 */
class BlueZ_Datagrid_Source_DbTable extends BlueZ_Datagrid_Source_DbSelect {
     ...
     *  
     * @param   mixed     $source
     * @return  BlueZ_Datagrid_Source_DbTable
     */
    public function bind($source)
    {
        ...
        $this->_table = $source;
        $this->_adapter = $source->getAdapter();
